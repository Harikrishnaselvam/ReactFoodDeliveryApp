...
const NewsLetter = () => {
  return (
    <div className='max-width-[1520px] text-white m-auto px-4 bg-[#24262b]'>
      <div className='mx-auto grid lg:grid-cols-3'>
          ...
          <div className='my-4'>
            <div className='flex flex-col sm:flex-row justify-center items-center w-full'>
                    ...
                    />
                    <button className='bg-[#00df9a] rounded-md text-white font-medium w-[200px] ml-4 my-6 px-6  py-3 border-none'>
                        Notify Me
                    </button>
            </div>
