...
const Delivery = () => {
  return (
    <div className='w-full px-4 py-16 bg-white'>
        ...
        <div className='w-[1240-px] mx-auto grid md:grid-cols-2'>
            ...
            <div className='flex flex-col justify-center'>
                ...
                <h3 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 '>Limitless Convenience on-demand</h3>
                <p>
                    ...
                    lestiae delectus culpa hic assumenda, voluptate reprehenderit
                    dolore autem cum ullam sed odit perspiciatis. Doloribus quos velit,
                    eveniet ex deserunt fuga?
                </p>
                <button className='bg-black text-[#00fd9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'>Get Started</button>
            </div>
        </div>
    </div>
  )
